...
/
create or replace view xxdoo_db_tab_pk_cols_v of xxdoo_db_column with object oid(id) as
  select cast(null as integer) instance_version,
         null id,
         tt.id owner_id,
         cc.name,
...
/
create or replace view xxdoo_db_tabs_v of xxdoo_db_tab with object oid(id) as
