...
declare 
  ...
  s xxdoo.xxdoo_db_scheme_typ := xxdoo.xxdoo_db_scheme_typ(p_name => 'Books', p_dev_code => null, p_owner => null);
...
begin
  ...
  l_prg := xxdoo.xxdoo_db_dao_generator_pkg.dao_generate(p_scheme => s, p_main_entity_name => 'books', p_with_xml => false);
